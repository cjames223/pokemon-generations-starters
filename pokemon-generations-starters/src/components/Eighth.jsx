        ...
        return (
            <div className='wrapper'>
                ...
                <div>
                    ...
                    <span id='pokemon' className={pokemon5.types[0].type.name}>{pokemon5.types[0].type.name[0].toUpperCase() + pokemon5.types[0].type.name.slice(1)}</span>
                ...
                <div>
                    ...
                    <span id='pokemon' className={pokemon6.types[0].type.name}>{pokemon6.types[0].type.name[0].toUpperCase() + pokemon6.types[0].type.name.slice(1)}</span>
